...
## Instructions:
- Download this file. Sometimes if you donwload xml files in github, they can have some problems. Please donwload the whole project (zip) and uncompress it.
- Backup original karoo theme (offline_v8.xml) before replacing it with this one. You can also donwload the raw file (not copy the raw file).
